...
const methodologyEvidence = ["data/","tools/"];
const quickStartCommands = ["python -m http.server 8080"];
const architectureIdentifiers = ["app.js","tools/"];
const thirdPartyExclusions = ["World Bank and UN Comtrade data","logos, trademarks, screenshots, and external assets"];
const licenseDecision = "preserve-mit";

test("MonarchCastleTech/macrointel exposes the complete repository documentation contract", () => {
...
test("MonarchCastleTech/macrointel keeps every managed image local and ships a valid social preview", () => {
...
test("MonarchCastleTech/macrointel documents citation, rights, and HTTPS policy", () => {
